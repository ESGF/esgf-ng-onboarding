...
After you’ve received confirmation from the appropriate group, you will develop a Controlled Vocabulary (CV) for your project that will be managed via [esgf-vocab](https://esgf.github.io/esgf-vocab) (the `esgvoc` package).   We recommend you verify the CVs using the software.  Once complete, the corresponding STAC catalog should populate in the STAC Discovery APIs listed above.
